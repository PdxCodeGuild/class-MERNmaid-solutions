...
const wizardStudents = wizards.filter((wizard) => {
    return wizard.hogwartsStudent;
})
// console.log(wizardStudents)

// Create an arrray of just students names
const studentNames = wizards.filter(wizard => wizard.hogwartsStudent).map(wizard => wizard.name)
// console.log(wizardNames)

// Create an array of people and their age who are born before 1970
// ex: {name: "lord Voldemort", age: 96}
const oldWizards = wizards
