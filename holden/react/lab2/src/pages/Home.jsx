...
const Home = () => {
  ...
  return (
    <div>
      ...
      <img src="https://avatars.githubusercontent.com/u/22627990?v=4" alt="some koala (my profile picture on github)" title="I am definitely human, this picture just is from a bad angle">
      <h3>What I know:</h3>
      <ul>
        <li>Python</li>
        <li>Elephant</li>
