...
// 		// if the current animal is cat, could have written as function.
// 		animals.splice(animal, 1); // remove cat from array
// 	}
// }
const index = animals.indexOf("cat"); // get the index of cat
animals.splice(index, 1); // remove cat from array
console.log(animals);
...
console.log(
	`Distance between (1, 5) and (2, 6): ${points.distanceBetween(2, 6)}\n`
